...
module m_configurations
  ...
  subroutine number_vm_confs(ij,ipar,itz,this)
    use constants
    use m_sp
    implicit none
  ...
  subroutine setup_vm_confs(ij,ipar,itz,this)
    use constants
    use m_sp
    implicit none
  ...
  SUBROUTINE number_vm3_confs(jj,ipar,itz,this)
    use constants
    USE m_sp
    ...
    INTEGER :: jj, ipar, itz, la, lb, lc, ja, jb, jc, na, nb, nc, &
         a, b, c, nconfs, itza, itzb, itzc
         
    INTEGER :: orb_low, orb_high, ma,mb,mc
    nconfs=0
  ...
  SUBROUTINE setup_vm3_confs(jj,ipar,itz,this)
    use constants
    USE m_sp
    ...
    TYPE (m_configuration_descriptor), INTENT(INOUT) :: this
    INTEGER :: jj, ipar, itz, la, lb, lc, ja, jb, jc, na, nb, nc, &
         a, b, c, nconfs, k1, k2, k3, itza, itzb, itzc
    INTEGER :: orb_low, orb_high , ma,mb,mc
    nconfs=0
