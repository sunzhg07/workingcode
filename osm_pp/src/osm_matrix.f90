subroutine sm_matrix
 ...
 function moverlap(a,b)
   ...
   integer::ia,ib,ic,nucbit
   real*8:: tmp,tmp1,val
   integer*16:: bra_p,ket_p,bra_n,ket_n,c1,c2,c3,c4,ucbit,bit_back
   integer:: bra,ket
   integer*16:: nxor,one
  integer:: bt_maskp(20),bt_maskn(20),bt_mask(40),bit_change(6),bit_uc(40)
  integer:: ncbitn,ncbitp
  integer :: sig
  moverlap=0.d0
