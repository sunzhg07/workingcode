subroutine ini_interactions
  ...
  integer:: nmtx,a,b,c,d,i,j,k,bra,ket,ii
  integer:: nconfs
  real*8:: gmat
  ...
  nconfs=0
    DO itz=-1,1 
      ...
      DO p_parity=0,1           
        ...
        DO ang_mom=-101,101
          call number_vm_confs(ang_mom,p_parity,itz,bra_configs)
    ...
    DO itz=-1,1 
      ...
      DO p_parity=0,1           
        ...
        DO ang_mom=-101,101
          ...
          call setup_vm_confs(ang_mom,p_parity,itz,bra_configs)
  ...
  number_channels=0
    DO itz=-3,3,2 
      ...
      DO p_parity=0,1           
        !     loop over angular momenta
        DO ang_mom=-101,101
          call number_vm3_confs(ang_mom,p_parity,itz,bra_configs)
          if(bra_configs%number_confs==0)cycle
          number_channels=number_channels+1
        enddo
      enddo
    ...
    DO itz=-3,3,2
      ...
      DO p_parity=0,1           
        ...
        DO ang_mom=-101,101
          ...
          call setup_vm3_confs(ang_mom,p_parity,itz,bra_configs)
